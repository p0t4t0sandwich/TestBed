...
tasks.register<ShadowJar>("relocateFabricJar") {
    ...
    dependencies {
        exclude("dev/neuralnexus/testbed/mixin/v1_7_10/vanilla/**")
    }
    relocate("dev.neuralnexus.testbed.v1_7_10.vanilla", "dev.neuralnexus.testbed.v1_7_10.l_intmdry")
}
...
unimined.minecraft(sourceSets.getByName("forge")) {
    ...
    minecraftForge {
        loader(forgeVersion)
        mixinConfig("testbed.mixins.v1_7_10.forge.json")
    }
    defaultRemapJar = true
}
...
tasks.register<ShadowJar>("relocateForgeJar") {
    ...
    relocate("dev.neuralnexus.testbed.v1_7_10.vanilla", "dev.neuralnexus.testbed.v1_7_10.l_searge")
}
