...
tasks.register<ShadowJar>("relocateFabricJar") {
    ...
    dependencies {
        exclude("dev/neuralnexus/testbed/mixin/v1_20_6/vanilla/**")
    }
    relocate("dev.neuralnexus.testbed.v1_20_6.vanilla", "dev.neuralnexus.testbed.v1_20_6.y_intmdry")
}
...
tasks.register<ShadowJar>("relocateForgeJar") {
    ...
    dependencies {
        exclude("dev/neuralnexus/testbed/mixin/v1_20_6/vanilla/**")
        exclude("dev/neuralnexus/testbed/v1_20_6/vanilla/**")
    }
}
