...
tasks.register<ShadowJar>("relocateFabricJar") {
    ...
    dependencies {
        exclude("dev/neuralnexus/testbed/mixin/v1_16_1/vanilla/**")
    }
    relocate("dev.neuralnexus.testbed.v1_16_1.vanilla", "dev.neuralnexus.testbed.v1_16_1.y_intmdry")
}
...
unimined.minecraft(sourceSets.getByName("forge")) {
    ...
    minecraftForge {
        loader(forgeVersion)
        mixinConfig("testbed.mixins.v1_16_1.forge.json")
    }
    defaultRemapJar = true
}
...
tasks.register<ShadowJar>("relocateForgeJar") {
    ...
    relocate("dev.neuralnexus.testbed.v1_16_1.vanilla", "dev.neuralnexus.testbed.v1_16_1.l_searge")
}
