...
tasks.register<ShadowJar>("relocateFabricJar") {
    ...
    dependencies {
        exclude("dev/neuralnexus/testbed/mixin/v1_21_5/vanilla/**")
    }
    relocate("dev.neuralnexus.testbed.v1_21_5.vanilla", "dev.neuralnexus.testbed.v1_21_5.y_intmdry")
}
...
tasks.register<ShadowJar>("relocateForgeJar") {
    ...
    dependencies {
        exclude("dev/neuralnexus/testbed/mixin/v1_21_5/vanilla/**")
        exclude("dev/neuralnexus/testbed/v1_21_5/vanilla/**")
    }
}
