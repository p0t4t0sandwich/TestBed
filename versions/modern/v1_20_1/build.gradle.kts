...
tasks.register<ShadowJar>("relocateFabricJar") {
    ...
    relocate("dev.neuralnexus.testbed.v1_20_1.vanilla", "dev.neuralnexus.testbed.v1_20_1.y_intmdry")
}
...
unimined.minecraft(sourceSets.getByName("forge")) {
    ...
    minecraftForge {
        loader(forgeVersion)
        mixinConfig("testbed.mixins.v1_20_1.forge.json")
    }
    defaultRemapJar = true
}
...
tasks.register<ShadowJar>("relocateForgeJar") {
    ...
    relocate("dev.neuralnexus.testbed.v1_20_1.vanilla", "dev.neuralnexus.testbed.v1_20_1.searge")
}
