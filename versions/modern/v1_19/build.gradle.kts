...
tasks.register<ShadowJar>("relocateFabricJar") {
    ...
    dependencies {
        exclude("dev/neuralnexus/testbed/mixin/v1_19/vanilla/**")
    }
    relocate("dev.neuralnexus.testbed.v1_19.vanilla", "dev.neuralnexus.testbed.v1_19.y_intmdry")
}
...
unimined.minecraft(sourceSets.getByName("forge")) {
    ...
    minecraftForge {
        loader(forgeVersion)
        mixinConfig("testbed.mixins.v1_19.forge.json")
    }
    defaultRemapJar = true
}
...
tasks.register<ShadowJar>("relocateForgeJar") {
    ...
    relocate("dev.neuralnexus.testbed.v1_19.vanilla", "dev.neuralnexus.testbed.v1_19.searge")
}
