...
configurations {
    ...
    setupConfigurations("fabric", "forge")
}
...
tasks.register<ShadowJar>("relocateFabricJar") {
    ...
    dependencies {
        exclude("dev/neuralnexus/testbed/mixin/v1_14_4/vanilla/**")
    }
    relocate("dev.neuralnexus.testbed.v1_14_4.vanilla", "dev.neuralnexus.testbed.v1_14_4.y_intmdry")
}
...
unimined.minecraft(sourceSets.getByName("forge")) {
    ...
    minecraftForge {
        loader(forgeVersion)
        mixinConfig("testbed.mixins.v1_14_4.forge.json")
    }
    defaultRemapJar = true
}
...
tasks.register<ShadowJar>("relocateForgeJar") {
    ...
    relocate("dev.neuralnexus.testbed.v1_14_4.vanilla", "dev.neuralnexus.testbed.v1_14_4.l_searge")
}
